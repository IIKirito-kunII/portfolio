...
const Contact = () => {
  ...
  const email = "lavishkumarvarshney@gmail.com";
  ...
  return (
    <>
      <div
        id="window-header"
        onDoubleClick={() => maxWindow("contact")}
        className="flex items-center justify-between window-drag-handle"
      >
        <WindowControls target="contact" />
        <h2 className="flex-1 text-center">Contact Me [ n_n)/ ]</h2>
        <a href={`mailto:${email}`} title={`Email: ${email}`} className="icon">
          <Mail size={17} />
        </a>
      </div>
      <div className="p-5 space-y-5">
        ...
        <p>lavishkumarvarshney@gmail.com</p>
        <ul>
          ...
          <li>
            <img
              src="/images/sdp.jpeg"
              alt="Lavish Kumar Varshney"
              loading="lazy"
            />
          </li>
        </ul>
        <a
          href="https://calendly.com/lavishkumarvarshney/30min"
          target="_blank"
        >
          <img
            width="630"
            className="hover:scale-102 origin-center transition-all duration-300"
            alt="meet_link"
            src="https://user-images.githubusercontent.com/15426564/144297439-f530f383-e73e-41e0-9914-a9b7d3f432e5.png"
          />
        </a>
      </div>
